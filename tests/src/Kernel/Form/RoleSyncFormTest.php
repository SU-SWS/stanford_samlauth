...
use Drupal\stanford_samlauth\Service\StanfordSSPWorkgroupApiInterface;
 ...
 *
 * @package Drupal\Tests\stanford_samlauth\Unit\Form
 * @coversDefaultClass \Drupal\stanford_samlauth\Form\RoleSyncForm
 */
class RoleSyncFormTest extends KernelTestBase {
   ...
   * @var string
   */
  protected $formId = '\Drupal\stanford_samlauth\Form\RoleSyncForm';
  ...
  protected function runFormSubmit() {
    ...
    $this->assertEmpty(\Drupal::config('stanford_samlauth.settings')
    ...
    $this->assertEquals(__DIR__ . '/test.crt', \Drupal::config('stanford_samlauth.settings')
      ->get('workgroup_api_cert'));
  }
  ...
  protected function setWorkgroupApiMock(bool $successful_connection = FALSE) {
    ...
    \Drupal::getContainer()->set('stanford_samlauth.workgroup_api', $workgroup_api);
  }
