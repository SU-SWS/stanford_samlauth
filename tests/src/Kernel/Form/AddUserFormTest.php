 ...
 * @coversDefaultClass \Drupal\stanford_samlauth\Form\AddUserForm
 */
class AddUserFormTest extends KernelTestBase {
  ...
  public function testAvailableRoles() {
    $form = \Drupal::formBuilder()
      ->getForm('\Drupal\stanford_samlauth\Form\AddUserForm');
  ...
  public function testFormSubmit() {
    ...
    \Drupal::formBuilder()
      ->submitForm('\Drupal\stanford_samlauth\Form\AddUserForm', $form_state);
