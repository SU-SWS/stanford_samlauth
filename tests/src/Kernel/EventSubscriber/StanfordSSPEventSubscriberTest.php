...
use Drupal\stanford_samlauth\EventSubscriber\StanfordSSPEventSubscriber;
 ...
 *
 * @package Drupal\Tests\stanford_samlauth\Kernel\EventSubscriber
 * @coversDefaultClass \Drupal\stanford_samlauth\EventSubscriber\StanfordSSPEventSubscriber
 */
class StanfordSSPEventSubscriberTest extends KernelTestBase {
  ...
  public function testKernelResponse() {
    ...
    $listener = \Drupal::service('stanford_samlauth.event_subscriber');
